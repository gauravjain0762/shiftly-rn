export const API = {
  ...
  getCompanySkills: '/company/getSkills',
  getCompanyEducations: '/company/getEducations',
  getCompanyExperiences: '/company/getExperiences',
  getCompanyCertifications: '/company/getCertifications',
  getCompanyLanguages: '/company/getLanguages',
  ...
  getExperiences: '/company/getExperiences',
